...
工具: post-progress/post-message/check-inbox/thread-context/fetch-thread-history/message-search/list-threads/feat-index/list-tasks/pending-mentions/create-task/claim-task/update-task/create-rich-block/search-evidence/reflect/retain-memory/write-memory/request-permission
