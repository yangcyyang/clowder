...
export const ENV_VARS: EnvDefinition[] = [
  ...
  },
  {
    ...
    defaultValue: '300000',
    description: '孤儿草稿清理宽限期（毫秒），用于避免刚生成的草稿被过早回收。',
    category: 'storage',
    sensitive: false,
    restartRequired: true,
  },
  ...
  {
    name: 'CAT_CAFE_GPT_IMAGE_API_KEY',
    defaultValue: '(未设置 → 优先使用账号系统 OpenAI key，其次 OPENAI_API_KEY)',
    description: 'GPT 图片生成专用 OpenAI API Key。通常不用单独设置，除非希望图片生成走独立 key。',
    category: 'codex',
    sensitive: true,
    restartRequired: true,
  },
  {
    name: 'CAT_CAFE_GPT_IMAGE_BASE_URL',
    defaultValue: '(未设置 → OpenAI 账号 baseUrl 或 https://api.openai.com/v1)',
    description: 'GPT 图片生成 API Base URL（兼容 OpenAI 网关）。',
    category: 'codex',
    sensitive: false,
    restartRequired: true,
  },
  {
    name: 'CAT_CAFE_GPT_IMAGE_MODEL',
    defaultValue: 'gpt-image-2',
    description: 'GPT 图片生成模型名。',
    category: 'codex',
    sensitive: false,
    restartRequired: true,
  },
  {
    name: 'CAT_CAFE_GPT_IMAGE_CONCURRENCY',
    defaultValue: '3',
    description: 'GPT 图片生成并发上限，默认 3 路，避免批量任务打爆 API。',
    category: 'codex',
    sensitive: false,
    restartRequired: true,
  },
  {
    name: 'CAT_CAFE_GPT_IMAGE_TIMEOUT_MS',
    defaultValue: '120000',
    description: '单次 GPT 图片生成请求超时时间（毫秒）。',
    category: 'codex',
    sensitive: false,
    restartRequired: true,
  },
  {
    name: 'CAT_CAFE_GPT_IMAGE_MAX_RETRIES',
    defaultValue: '2',
    description: 'GPT 图片生成遇到 429/5xx 或网络错误时的最大重试次数。',
    category: 'codex',
    sensitive: false,
    restartRequired: true,
  },
  ...
  },
  {
    ...
    defaultValue: '(未设置)',
    description: '项目上下文注入白名单，逗号分隔 project id；未设置时不额外注入指定项目事实源。',
    category: 'evidence',
    sensitive: false,
    restartRequired: true,
  },
  {
    ...
    defaultValue: '0',
    description: '只读知识库索引的密钥隔离开关；设为 1 时疑似密钥笔记只进入隔离报告，不入正文索引。',
    category: 'evidence',
    sensitive: false,
    restartRequired: true,
  },
  {
    ...
    defaultValue: '0',
    description: '关闭自动记忆写入；设为 1 时 AgentMemoryAutoWriter 不再自动沉淀候选记忆。',
    category: 'evidence',
    sensitive: false,
    restartRequired: true,
  },
