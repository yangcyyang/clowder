...
export const ENV_VARS: EnvDefinition[] = [
  ...
  // --- F163 记忆熵减：功能层已于 2026-07-26 裁剪（prune-w2b），以下 7 个休眠 flag 因被受保护的
  // 记忆主干（SqliteEvidenceStore 等经 f163-types.ts freezeFlags() 读取）保留而继续登记。
  // 全部默认 off、生产从未设置、无 UI 入口；彻底摘除待记忆主干后续演进时一并手术。 ---
  {
    name: 'F163_AUTHORITY_BOOST',
    defaultValue: 'off',
    description: 'F163 authority 加权 rerank (off/shadow/on)（功能层已裁剪，休眠存根）',
    category: 'evidence',
    sensitive: false,
    runtimeEditable: true,
  },
  {
    ...
    defaultValue: 'off',
    description: 'F163 constitutional 物理注入 (off/shadow/on)（功能层已裁剪，休眠存根）',
    category: 'evidence',
    sensitive: false,
    runtimeEditable: true,
  },
  {
    ...
    defaultValue: 'off',
    description: 'F163 多轴元数据 rerank (off/shadow/on)（功能层已裁剪，休眠存根）',
    category: 'evidence',
    sensitive: false,
    runtimeEditable: true,
  },
  {
    ...
    defaultValue: 'off',
    description: 'F163 非替代式压缩 (off/suggest/apply)（功能层已裁剪，休眠存根）',
    category: 'evidence',
    sensitive: false,
    runtimeEditable: true,
  },
  {
    ...
    defaultValue: 'off',
    description: 'F163 晋升门禁 (off/suggest/apply)（功能层已裁剪，休眠存根）',
    category: 'evidence',
    sensitive: false,
    runtimeEditable: true,
  },
  {
    ...
    defaultValue: 'off',
    description: 'F163 矛盾检测 (off/suggest/apply)（功能层已裁剪，休眠存根）',
    category: 'evidence',
    sensitive: false,
    runtimeEditable: true,
  },
  {
    ...
    defaultValue: 'off',
    description: 'F163 审计 review queue (off/suggest/apply)（功能层已裁剪，休眠存根）',
    category: 'evidence',
    sensitive: false,
    runtimeEditable: true,
  },
