        ...
        if (block.type === 'image') {
          ...
          return (
            ...
            <img
              ...
              src={src}
              alt="attached image"
              className="mt-2 max-h-[200px] max-w-full cursor-pointer rounded-lg border border-[var(--console-border-soft)] object-contain transition-opacity hover:opacity-90 sm:max-w-sm"
