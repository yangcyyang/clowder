...
export function TtsPlayButton({
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity ml-1 p-0.5 rounded hover:bg-cafe-surface-elevated text-cafe-muted hover:text-cafe-secondary"
