...
const EXPECTED_TOOLS = [
  ...
  // 批次 2-C: task-* dual-auth surface (Raft CLI parity) + message search
  'cat_cafe_task_claim',
...
const KNOWN_WRITE_TOOLS = [
  ...
  'cat_cafe_task_unclaim',
  'cat_cafe_reply_in_thread',
  'cat_cafe_task_list', // requires callback credentials unavailable in readonly
  'cat_cafe_search_messages', // requires callback credentials unavailable in readonly
  'cat_cafe_create_rich_block',
  'cat_cafe_generate_document',
  'cat_cafe_request_permission',
  'cat_cafe_update_workflow',
